...
def main():
    ...
    for key in recipe_cfgs:
        ...
        for exp_cnt in experiments:
            ...
            # plt.xticks(np.arange(steps.min()-1, steps.max() + 1, step=x_step))
            # print(f"> Plotting complete for this experiment.")
        ...
        if enable_legend:
            plt.legend(
                ...
                bbox_to_anchor=(0.5, 1.15),  # Center it horizontally, move it up
